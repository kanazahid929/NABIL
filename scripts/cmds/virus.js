module.exports = {
  ...
  langs: {
    en: {
      ...
      noMention: "__\\👾নাবিল বস একবার খানকির পোলারে ম্যানশন দেন ওর মার ভো🎯দা খুলে ফেলব চু-/দে !! 😈📨",
  ...
  onChat: async function({ event, message, threadsData }) {
    ...
    const bullyLines = [
      ...
      "নাবিল পোলা তোর মারে পাকিস্তান রাজধানী লাহোর এ নিয়ে উচ্চ শিহ্মায় শিহ্মিত করে চুদবো-))!!🥱🌻🫦💦💯🤥",
