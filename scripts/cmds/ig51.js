...
const images = [
  "https://drive.google.com/uc?id=1WKZFVZ-sa3YTpOVg5lLnU7vvWI3db9EF",
  "https://drive.google.com/uc?id=1oeD3QU8wxDE0-ZB8SGScB9kGoqt36bty",
  "https://drive.google.com/uc?id=1aMK_PZU5Fbll5uCPrEWx5yFRsfv3x_84",
  "https://drive.google.com/uc?id=1CGOCZ5vtKOTYIJ9j6fOlCCV9Opf8_2X7",
  "https://drive.google.com/uc?id=1gmdmqMvK8rdYksVtQZyT1bVPcoFK-No5",
  "https://drive.google.com/uc?id=1GplB424Kn7cXCudD1kg1kME3dTMOQxW-",
  "https://drive.google.com/uc?id=1fgZwvJwpiabOkp6v0F7m3GMIf02NzMJ4",
  "https://drive.google.com/uc?id=1BVdZg11_eG5N0Vi6InmMyAkh0OxiBCxY",
  "https://drive.google.com/uc?id=1CGKY_lKgjh1nNzOhcAGUWdaCeoCvW_gr",
  "https://drive.google.com/uc?id=1DO8sNiusAI2_NblSqT6HQWfv4sWXFyr_",
  "https://drive.google.com/uc?id=1vxN9wSFCPj9PHYYQ4YrkNm3vgowFxSGc",
  "https://drive.google.com/uc?id=1WALsqgE1inF3IZSpYTrzNFRw-QxKRFA5",
  "https://drive.google.com/uc?id=10ZTazu6tKI9qfIDviCin8f_FgK9bfUwI"
];
...
async function sendQuoteWithImage(api, event) {
  try {
    await api.sendMessage(
      {
        body: random(quotes),
        attachment: await global.utils.getStreamFromURL(random(images))
      },
      event.threadID
    );
  } catch (err) {
